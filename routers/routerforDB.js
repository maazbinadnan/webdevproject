...
router2.get("/alldata",DBcontroller.alldata); //after coming here it will check if there is any /alldata in the url after /database and then it will go to DBcontroller.alldata function
